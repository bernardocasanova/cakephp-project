        ...
        setTimeout(function()
        {
          ...
          $.ajax({
            ...
            data: {
              ...
              "data[User][password]": $("input#password").val(),
            },
            error: function()
            {
              alert("Ops.. Ocorreu um erro. Atualize página e tente novamente!");
            ...
            success: function(response)
            {
              ...
              setTimeout(function()
              {
                ...
                {
                  var message = 'Informe corretamente seu <strong>e-mail</strong> e <strong>senha</strong>';
