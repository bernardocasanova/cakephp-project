...
<head>
    ...
    <title>Login | <?php echo $radio['Radio']['name']; ?> | Manager</title>
...
<body class="page-body login-page login-form-fall">
    ...
    var attemptUrl = "<?php echo $this->Html->url(array('controller' => 'radios_users', 'action' => 'attempt', 'plugin' => 'radio', 'radioSlug' => $this->params['radioSlug'])); ?>";
    </script>
